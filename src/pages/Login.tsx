      ...
      <div className="max-w-4xl w-full">
        ...
        >
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 p-8 lg:p-12 flex flex-col justify-center items-center text-center text-white">
              <motion.div
              ...
              >
                ...
                <h1 className="text-4xl font-bold mb-4">Trade Manthan</h1>
                <p className="text-xl text-primary-100 leading-relaxed">
                  Advanced Crypto Trading Platform with AI-Powered Strategies
                </p>
              </motion.div>
